        ...
        <>
            <div className={"bg-invited min-h-screen bg-cover bg-bottom pb-10"}>
                ...
                " opacity-100"}>
                    ...
                    <h1 className={"md:text-6xl text-5xl md:mb-0 font-medium text-gray-100 leading-relaxed font-curs"}>Hello,
                        {/* eslint-disable-next-line react/no-unescaped-entities */}
                        You're Invited</h1>
                    <br/>
                    <h1 className={"md:text-2xl text-xl font-medium text-gray-100 leading-relaxed"}>- Save the date of our
                        wedding. -</h1>
                    <p className={"text-gray-100"}>Minggu. 13 Agustus 2023</p>
                    <br/>
                    <input type="text"
